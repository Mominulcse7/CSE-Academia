...
/**
 * Created by Ripon on 9/28/2018.
 */

public class PostUpdateDeleteList extends ArrayAdapter<PostConstructor> {
    private Activity context;
    List<PostConstructor> posts;

    public PostUpdateDeleteList(Activity context, List<PostConstructor> posts) {
